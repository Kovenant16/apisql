...
export const getUbicacionPorUsuario = async (req, res) => {
    try {
        const [result] = await pool.query("SELECT idUbicacion, ub.idUsuario, telefonoUbicacion, direccionUbicacion, latUbicacion, longUbicacion, referenciaUbicacion, asuntoUbicacion FROM ubicacion ub, usuario us WHERE ub.idUsuario = us.idUsuario AND us.nombreUsuario = ?;", [
